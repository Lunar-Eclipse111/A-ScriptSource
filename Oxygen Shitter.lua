...
local win = lib:Window("OXYGEN SHITTER",Color3.fromRGB(255, 255, 255), Enum.KeyCode.RightControl)

local tab = win:Tab("Main")

tab:Slider("Walkspeed",0,35,30, function(s)
game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

tab:Slider("Jumppower",0,200,30, function(s)
game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
end)

tab:Slider("FOV",0,120,70, function(s)
workspace.CurrentCamera.FieldOfView = s
end)

tab:Slider("Gravity",0,300,30, function(s)
...
local tab = win:Tab("Silent Aim")

tab:Button("TP silent Aim", function()
    ...
    lib:Notification("Notification", "PRESS F", "ok")
    end)


    tab:Slider("FOV size",0,500,300, function(t)
        FOV_Circle.Radius = t
        end)

        tab:Button("Lock x", function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Ryleyxx12/esptracersEZ/main/EzTracers",true))();
            lib:Notification("Notification", "Hello!", "Hi!")
            end)
    

        tab:Colorpicker("Fov color",Color3.fromRGB(255,255,255), function(t)
            FOV_Circle.Color = t
            end)
            ...
            local tab = win:Tab("HBE")

            tab:Button("hbe+chams+targethitboxes", function()
                getfenv().hbe = true
    ...
    elseif getfenv().hbe == false then
        print('disabled hbe')
                ...
                lib:Notification("Notification", "op hitboxes", "ok")
                end)
...
tab:Button("free autofarm click here", function()
...
game.Players.LocalPlayer.Character['Left Arm']:remove()
    ...
    lib:Notification("Notification", "bit buggy", "Hi!")
    end)
